import { BiBook, BiPen, BiQr, BiTask } from 'react-icons/bi'
        ...
        <div className="grid gap-4 py-8 px-8">
          {[...Array(3)].map((_, i) => (
            <div className='w-full flex items-stretch gap-2'>
              <MainCard key={i} title="Informatika" size="20:00 WIB" date="Senin, 23 Januari 2025" />
              <BiQr className='text-4xl bg-white p-2 rounded shadow h-full w-20 aspect-square flex justify-center items-center'/>
            </div>
          ))}
        </div>
      </main>
